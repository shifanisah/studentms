...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Lupa Password</title>
    <!-- plugins:css -->
          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>PULIHKAN KATA SANDI</h4>
                <h6 class="font-weight-light">Masukan Alamat Email Dan Nomer Ponse untuk mengatur ulang Password!</h6>
