...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|||Kelola Pemberitahuan</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Kelola Pemberitahuan </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Kelola Pemberitahuan</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Kelola Pemberitahuan</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> tTampilkan Semua Pemberitahuan</a>
                    </div>
