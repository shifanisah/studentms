...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|||Kelola Siswa</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Kelola Siswa</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Tampilkan Semua Siswa</a>
                    </div>
