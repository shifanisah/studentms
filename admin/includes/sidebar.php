...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-notice.php"> Tambah Pemberitahuan </a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-notice.php"> Kelola Pemberitahuan </a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#auth1" aria-expanded="false" aria-controls="auth">
                <span class="menu-title">Pemberitahuan Publik</span>
                <i class="icon-doc menu-icon"></i>
              </a>
              <div class="collapse" id="auth1">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-public-notice.php"> Tambah Pemberitahuan Publik </a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-public-notice.php"> Kelola Pemberitahuan Publik</a></li>
                </ul>
              </div>
              <li class="nav-item">
