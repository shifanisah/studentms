...
<html lang="en">
  <head>
    ...
    <title>Student Management System|| Tampilan Profile Siswa</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Tampilan Profile Siswa </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Tampilan Profile Siswa</li>
                </ol>
              </nav>
            </div>
            <div class="row">
