...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Tampilkan Pemberitahuan</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Tampilkan Pemberitahuan </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Tampilkan Pemberitahuan</li>
                </ol>
              </nav>
            </div>
            <div class="row">
